...
<head>
    ...
    <title>Add Apartment - ApartmentHub Admin</title>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="text-center mb-4">
                <h1 class="hero-title">Add New Apartment</h1>
                <p class="text-white-50">Create a new apartment listing</p>
            </div>
            
            <div class="card glass border-0">
                <div class="card-body p-5">
                    <form action="../actions/save_apartment.php" method="POST">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-4">
                                ...
                                <input type="number" name="bedrooms" class="form-control" min="1" required>
                            </div>
                            <div class="col-md-3 mb-4">
                                <label class="form-label text-white">
                            ...
                            <div class="col-md-3 mb-4">
                                ...
                                <input type="number" name="area_sqm" class="form-control" min="1">
                            </div>
                            <div class="col-md-3 mb-4">
                                <label class="form-label text-white">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="amenities" class="form-control" placeholder="WiFi,Air Conditioning,Kitchen,TV" required>
                        </div>
